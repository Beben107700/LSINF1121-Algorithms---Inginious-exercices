...
public class TestUnion extends TestCase {
    ...
    public void testUnion6() {
        ...
        Interval i2 = new Interval(2, 2);
        assertTrue(Arrays.equals(Union.union(new Interval[]{i1, i2}), new Interval[]{new Interval(1, 1), new Interval(2, 2)}));
    }
    ...
    public void testUnion7() {
        ...
        Interval i2 = new Interval(2, 4);
        assertTrue(Arrays.equals(Union.union(new Interval[]{i0, i1, i2}), new Interval[]{new Interval(2, 4), new Interval(5, 9)}));
    }
    ...
    public void testUnion8() {
        ...
        assertTrue(Arrays.equals(Union.union(new Interval[]{i0, i1, i2, i3, i4, i5}), new Interval[]{new Interval(2, 4), new Interval(5, 9), new Interval(10, 10)}));
    }
